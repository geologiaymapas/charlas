"""
Suite de Detección y Análisis de Valores Atípicos
Detecta valores atípicos mediante múltiples métodos y
proporciona un análisis exhaustivo de su impacto y patrones.
"""
