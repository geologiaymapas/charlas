"""
Analizador y visualizador de distribución
Genera automáticamente visualizaciones de
distribución completas y pruebas estadísticas
para todas las características de un conjunto de datos.
"""
