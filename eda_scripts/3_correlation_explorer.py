"""
Explorador de Correlaciones y Relaciones
Analiza las relaciones entre variables mediante múltiples
métodos de correlación y detecta problemas de multicolinealidad.
"""
